...
const part1 = new Part(uuidv4(), 'drum part 1', 1, 0, 0)
const part2 = new Part(uuidv4(), 'drum part 2', 1, 0, 0)
const perf1 = new PartPerformance(uuidv4(), 1, part1.id)
const perf2 = new PartPerformance(uuidv4(), 2, part2.id)
const perf3 = new PartPerformance(uuidv4(), 3, part1.id)
const perf4 = new PartPerformance(uuidv4(), 4, part2.id)
const perf5 = new PartPerformance(uuidv4(), 5, part1.id)
const perf6 = new PartPerformance(uuidv4(), 6, part2.id)
const perf7 = new PartPerformance(uuidv4(), 7, part1.id)
const perf8 = new PartPerformance(uuidv4(), 8, part2.id)
const perf9 = new PartPerformance(uuidv4(), 9, part1.id)
const perf10 = new PartPerformance(uuidv4(), 10, part2.id)
const partElement1 = new PartElement(uuidv4(), part1.id, 'PATTERN', 1, 4, '1___1___', null)
const partElement2 = new PartElement(uuidv4(), part2.id, 'PATTERN', 1, 4, '1_1_1_1_', null)
