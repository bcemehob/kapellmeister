...
describe('instrumentTimelineDataFactory', () => {
    ...
    const expectedTimeline = [
        null,
        new PartySnapshot(party1Performance1.id, party1.id, beatValues(1,8), {}),
        new PartySnapshot(party1Performance1.id, party1.id, beatValues(1,8), {}),
        new PartySnapshot(party1Performance1.id, party1.id, beatValues(1,8), {}),
        new PartySnapshot(party1Performance1.id, party1.id, beatValues(1,8), {}),
        new PartySnapshot(party1Performance1.id, party1.id, beatValues(1,8), {}),
        ...
        new PartySnapshot(party2Performance1.id, party2.id, beatValues(9,8),
        ...
        new PartySnapshot(party1Performance2.id, party1.id, beatValues(17,8), {}),
        new PartySnapshot(party1Performance2.id, party1.id, beatValues(17,8), {}),
        new PartySnapshot(party1Performance2.id, party1.id, beatValues(17,8), {}),
        new PartySnapshot(party1Performance2.id, party1.id, beatValues(17,8), {}),
        new PartySnapshot(party1Performance2.id, party1.id, beatValues(17,8), {}),
        ...
        new PartySnapshot(party2Performance2.id, party2.id, beatValues(29,8),
            {'CHORDS':party2Element1.id}),
        new PartySnapshot(party2Performance2.id, party2.id, beatValues(29,8),
            {'CHORDS':party2Element1.id}),
        new PartySnapshot(party2Performance2.id, party2.id, beatValues(29,8),
