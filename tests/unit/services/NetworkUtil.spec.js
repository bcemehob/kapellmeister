...
describe("test", () => {
    ...
    it('should find first address (windows + wifi + ethernet) #3', () => {
        ...
        expect(localAddress()).toBe("192.168.0.111")
    })
    ...
    it('should find 172.x. address (macos + wifi) #5', () => {
        mockedInterfaces.current = mockedInterfaces_mac5
        expect(localAddress()).toBe("172.31.0.107")
    })

    it('should find 10.x. address (macos + wifi) #6', () => {
        mockedInterfaces.current = mockedInterfaces_mac6
        expect(localAddress()).toBe("10.254.254.107")
    })
...
const mockedInterfaces_mac5 = {
    utun0: [
        {
            address: '10.254.254.107',
            netmask: '255.255.255.0',
            family: 'IPv4',
            mac: '6f:7b:d3:5f:c2:ae',
            internal: false,
            cidr: '10.254.254.107/24'
        }
    ],
    en0: [
        {
            ...
            mac: '6f:7b:d3:5f:c2:ae',
            internal: false,
            cidr: '172.31.0.107/24'
        }
    ],
}

const mockedInterfaces_mac6 = {
    en0: [
        {
            address: '172.32.0.107',
            netmask: '255.255.255.0',
            family: 'IPv4',
            mac: '6f:7b:d3:5f:c2:ae',
            internal: false,
            cidr: '172.32.0.107/24'
        }
    ],
    utun0: [
        {
