...
describe('InstrumentService', () => {
    ...
    it('can detect current party new', () => {
        expect(serviceNew.currentPart(0)).toStrictEqual(new PartViewAtBeat(null, null, null,
            new PartViewAtBeat("first", {start: 1, duration: 6}, [
                new PartElement("element-chords-1-1", "party1", "CHORDS", 1, 2, "Am", null)
            ], null)))
        expect(serviceNew.currentPart(1))
            .toStrictEqual(new PartViewAtBeat("first", {start: 1, duration: 6}, [
                    new PartElement("element-chords-1-1", "party1", "CHORDS", 1, 2, "Am", null)
                ],
                new PartViewAtBeat("second", {start: 7, duration: 6}, [], null)))
        ...
        expect(serviceNew.currentPart(7))
            .toStrictEqual(new PartViewAtBeat("second", {start: 7, duration: 6}, [],
                new PartViewAtBeat("first", {start: 13, duration: 6}, [
                    new PartElement("element-chords-1-1", "party1", "CHORDS", 1, 2, "Am", null)
                ], null)))
        ...
        expect(serviceNew.currentPart(13))
            .toStrictEqual(new PartViewAtBeat("first", {start: 13, duration: 6}, [
                    new PartElement("element-chords-1-1", "party1", "CHORDS", 1, 2, "Am", null)
                ],
                new PartViewAtBeat("second", {start: 19, duration: 6}, [], null)))
        expect(serviceNew.currentPart(18))
            .toStrictEqual(new PartViewAtBeat("first", {start: 13, duration: 6}, [],
                new PartViewAtBeat("second", {start: 19, duration: 6}, [], null)))
        expect(serviceNew.currentPart(19))
            .toStrictEqual(new PartViewAtBeat("second", {start: 19, duration: 6}, [],
                null))
