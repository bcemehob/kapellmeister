...
const timeline = [
    new PartySnapshot(null, "performance 1-1", null, null, null),

    new PartySnapshot("performance 1-1", "performance 2-1", "party1", beatValues(1,6),
    ...
    new PartySnapshot("performance 2-1", "performance 1-2", "party2", beatValues(7,6), {}),
    new PartySnapshot("performance 2-1", "performance 1-2", "party2", beatValues(7,6), {}),
    new PartySnapshot("performance 2-1", "performance 1-2", "party2", beatValues(7,6), {}),
    new PartySnapshot("performance 2-1", "performance 1-2", "party2", beatValues(7,6), {}),
    new PartySnapshot("performance 2-1", "performance 1-2", "party2", beatValues(7,6), {}),
    ...
    new PartySnapshot("performance 1-2", "performance 2-2", "party1", beatValues(13,6),
        { CHORDS: "element-chords-1-1" }),
    new PartySnapshot("performance 1-2", "performance 2-2", "party1", beatValues(13,6),
        { CHORDS: "element-chords-1-1", LYRICS: "element-lyrics-1-3" }),
    new PartySnapshot("performance 1-2", "performance 2-2", "party1", beatValues(13,6),
