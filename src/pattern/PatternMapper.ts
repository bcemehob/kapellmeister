...
export class PatternMapper {
    ...
    mapInstruments(rawInstruments: any[]): Instrument[] {
    ...
    mapInstrument(rawInstrument: any): Instrument {
    ...
    mapPartyPerformances(rawPartyPerformances: any[]): PartPerformance[] {
    ...
    mapPartyElements(rawPartElements: any[]): PartElement[] {
